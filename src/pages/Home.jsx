...
function Home() {
  return (
    <>
      {/* landing */}
      <div style={{ height: '100vh', backgroundImage: 'url("/land.png")', backgroundSize: 'cover', backgroundAttachment: 'fixed' }} className="d-flex justify-content-center align-items-center">
      ...
      <div className="container my-5">
        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-1"></div>
          <div className="col-lg-5">
            <img width={'100%'} height={'600px'} src="/about.png" alt="resume" />
          </div>
        </div>
      </div>
          ...
          <div className="col-lg-5">
            <div className="row">
              <div className="col-md-3">
                <img className='img-fluid p-2' src="/face1.png" alt="img" />
              </div>
              <div className="col-md-3">
                <img className='img-fluid p-2' src="/face2.png" alt="img" />
              </div>
              <div className="col-md-3">
                <img className='img-fluid p-2' src="/face3.png" alt="img" />
              </div>
              <div className="col-md-3">
                <img className='img-fluid p-2' src="/face4.jpg" alt="img" />
              </div>
              <div className="col-md-3">
                <img className='img-fluid p-2' src="/face5.jpg" alt="img" />
              </div>
              <div className="col-md-3">
                <img className='img-fluid p-2' src="/face6.jpg" alt="img" />
              </div>
              <div className="col-md-3">
                <img className='img-fluid p-2' src="/face7.jpg" alt="img" />
              </div>
              <div className="col-md-3">
                <img className='img-fluid p-2' src="/face8.jpg" alt="img" />
              </div>
              <div className="col-md-3">
                <img className='img-fluid p-2' src="/face9.jpg" alt="img" />
              </div>
              <div className="col-md-3">
                <img className='img-fluid p-2' src="/face10.jpg" alt="img" />
              </div>
              <div className="col-md-3">
                <img className='img-fluid p-2' src="/public/face11.jpg" alt="img" />
              </div>
              <div className="col-md-3">
                <img className='img-fluid p-2' src="/face1.png" alt="img" />
              </div>
